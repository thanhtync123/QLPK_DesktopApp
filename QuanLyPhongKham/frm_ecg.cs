...
{
    public partial class frm_ecg : Form
    {
        ...
        private void frm_ecg_Load(object sender, EventArgs e)
        {
    ...
    ";
        ...
        private void cb_template_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            string reportTitle = "PHIẾU KẾT QUẢ ĐIỆN TIM";
            ...
            // Draw X-ray result
            e.Graphics.DrawString("KẾT QUẢ ĐIỆN TIM", headerFont, Brushes.Black, new Point(leftMargin, yPos));
            yPos += 25;
